        ...
        <li>
          <details open>
            ...
            <ul className="ml-2 mt-2">
              <li>
                <Link to="/home/reportsteam" className="text-[#CCCCCC] hover:text-[#A8C5DA]" style={{ fontSize: '1.0rem' }}>
                  <FaChartPie size={21} /> Report
                </Link>
              </li>
              <li>
                <Link to="/home/addTeamMembers" className="text-[#CCCCCC] hover:text-[#A8C5DA]" style={{ fontSize: '1.0rem' }}>
                  <RiBookMarkedLine size={21} /> Add Team members
                </Link>
              </li>
            </ul>
          </details>
